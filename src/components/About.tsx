...
export default function About() {
  const traits = [
    {
      icon: <Clapperboard className="w-4 h-4 text-black" />,
      title: 'Cineasta',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <p className="font-serif italic text-zinc-700 text-base sm:text-lg leading-relaxed mt-2">
              "La creatividad es la capacidad de resolver problemas con soluciones que no son evidentes" — <strong className="text-black font-semibold not-italic">José Miguel Miño</strong>.
            </p>
            ...
            <p className="text-zinc-600 text-xs sm:text-sm font-light tracking-wide leading-relaxed">
