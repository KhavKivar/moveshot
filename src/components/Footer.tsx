        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-12 border-b border-zinc-200">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10">
            <div className="flex flex-col text-center sm:text-left gap-1.5 text-mono">
              ...
              <a href="mailto:contacto@moveshot.cl" className="text-xs font-mono text-zinc-900 hover:text-black transition-all">
            ...
            <div className="flex flex-col text-center sm:text-left gap-1.5 text-mono">
              ...
              <a 
                ...
                className="text-xs text-zinc-900 hover:text-black transition-all flex items-center justify-center sm:justify-start gap-1 font-mono"
              >
                @josemiraw.mino
          ...
          <button
            onClick={scrollToTop}
            className="p-3 rounded-sm bg-white border border-zinc-200 text-zinc-500 hover:text-black hover:border-black transition-all cursor-pointer shadow-sm"
            title="Volver Arriba"
          >
